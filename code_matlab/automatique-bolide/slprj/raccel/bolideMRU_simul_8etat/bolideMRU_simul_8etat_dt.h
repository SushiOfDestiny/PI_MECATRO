...
rtBTransitions [ ] = { { ( char_T * ) ( & rtB . mx20xi1qvn [ 0 ] ) , 0 , 0 ,
20 } , { ( char_T * ) ( & rtDW . llhn4bw3ym ) , 6 , 0 , 1 } , { ( char_T * )
( & rtDW . jhmp3qvn5s ) , 10 , 0 , 4 } , { ( char_T * ) ( & rtDW . gdaqfrous0
) , 3 , 0 , 1 } , { ( char_T * ) ( & rtDW . hbnszvowgl ) , 8 , 0 , 1 } } ;
static DataTypeTransitionTable rtBTransTable = { 5U , rtBTransitions } ;
static DataTypeTransition rtPTransitions [ ] = { { ( char_T * ) ( & rtP .
Ipsi ) , 0 , 0 , 30 } } ; static DataTypeTransitionTable rtPTransTable = { 1U
, rtPTransitions } ;
